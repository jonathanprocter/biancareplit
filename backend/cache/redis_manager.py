    ...
    def init_app(self, app):
        ...
        try:
            ...
            if not redis_url:
                ...
                redis_host = app.config.get('REDIS_HOST', '0.0.0.0')  # Using 0.0.0.0 instead of localhost
        ...
        while self.connection_attempts < self.max_retries:
            try:
                ...
                if self.connection_attempts >= self.max_retries:
                    ...
                    self.connected = False
                    break
                self.logger.info(f"Redis connection attempt {self.connection_attempts} failed, retrying...")
