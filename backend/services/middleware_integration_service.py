    ...
    async def process_event(
        ...
        try:
            ...
            analytics_result = await self.analytics_service.process_event(
                session_id=session_id, event_type=event_type, event_data=event_data
            )
            ...
            await self.ws_manager.send_update(
                ...
                data={"event_data": event_data, "analytics": analytics_result},
            )
    ...
    async def update_session_state(
        ...
        try:
            ...
            analytics_update = await self.analytics_service.update_session_state(
                session_id=session_id, state_data=state_update
            )
            ...
            await self.ws_manager.send_update(
                ...
                data={"state": state_update, "analytics": analytics_update},
            )
