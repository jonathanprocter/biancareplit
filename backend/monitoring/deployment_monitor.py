...
class DeploymentMonitor:
    ...
    def check_system_health(self) -> Dict[str, Any]:
        ...
        return {
            ...
            'metrics': metrics,
            'alerts': [{'message': a.message, 'severity': a.severity.value} for a in alerts]
        }
    ...
    def check_health(self) -> Dict[str, Any]: #This function remains largely unchanged, but the alert integration is handled in check_system_health
