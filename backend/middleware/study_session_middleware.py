    ...
    def decorated_function(*args, **kwargs):
        ...
        try:
            ...
            metrics = {
                ...
                'average_time_per_question': sum(g.study_metrics.time_per_question) / len(g.study_metrics.time_per_question) if g.study_metrics.time_per_question else 0,
                'category_performance': g.study_metrics.category_performance,
                'accuracy_rate': (g.study_metrics.correct_answers / g.study_metrics.questions_attempted * 100) if g.study_metrics.questions_attempted > 0 else 0,
    ...
    def decorated_function(*args, **kwargs):
        ...
        try:
            ...
            metrics = {
                ...
                'response_time_percentile': calculate_response_time_percentile(duration, category)
            }
