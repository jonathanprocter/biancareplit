...
def get_user_performance():
    ...
    try:
        ...
        recent_attempts = QuestionAttempt.query.filter_by(user_id=user_id)\
        ...
        avg_time = sum(attempt.time_taken for attempt in recent_attempts) / total_attempts
        ...
        for category in NCLEX_CATEGORIES.values():
            ...
            if category_attempts:
                ...
                category_performance[category] = category_correct / len(category_attempts)
            else:
        ...
        return jsonify({
            'metrics': {
                ...
                'questionsAttempted': progress.questions_attempted if progress else 0
            },
