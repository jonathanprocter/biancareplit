...
from models import (
    Content, Flashcard, DifficultyLevel, SubjectCategory, 
    ContentType, Review, study_material_questions
)
...
async def create_flashcard_from_missed():
    try:
        ...
        flashcard = await ai_coach_service.create_flashcard_from_missed_question(question_id)
        ...
        if flashcard:
            return jsonify({
                ...
                'flashcard': {
                    ...
                    'nextReview': flashcard.next_review.isoformat() if flashcard.next_review else None
                }
            }), 200
