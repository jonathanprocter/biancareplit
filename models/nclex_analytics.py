...
class NCLEXAnalytics(db.Model):
    ...
    analysis_type = db.Column(db.String(50), nullable=False)  # 'performance', 'coverage', 'prediction'
    ...
    def predict_nclex_performance(self, topic_data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        try:
            ...
            correct_ratio = topic_data.get('correct_answers', 0) / max(topic_data.get('total_attempts', 1), 1)
    ...
    def calculate_mastery_level(self, score: float) -> str:
        ...
        elif score >= 0.65: return 'Proficient'
        elif score >= 0.45: return 'Developing'
