...
class SystemIntegration {
    ...
    async initialize(config = {}) {
        ...
        try {
                ...
                try {
                    ...
                    await Promise.race([
                        ...
                        new Promise((_, reject) => 
                            setTimeout(() => reject(new Error('Core services initialization timeout')), 
                    ...
                    throw new Error(`System initialization failed after ${retryCount} retries: ${error.message}`);
                }
            };
            ...
            this.wsUrl = initialConfig.wsUrl || process.env.REACT_APP_WS_URL || `ws://${window.location.hostname}:81/ws`;
            this.wsConfig = {
                ...
                const initializeWebSocket = async () => {
                    ...
                    try {
                        ...
                        this.ws.onclose = (event) => {
                            ...
                            console.log('[SystemIntegration] WebSocket connection closed', 
        ...
        try {
            ...
            while (retryCount < maxRetries) {
                try {
                    ...
                    retryCount++;
                    if (retryCount < maxRetries) {
                        console.warn(`[SystemIntegration] Analytics initialization retry ${retryCount}/${maxRetries}`);
    ...
    _scheduleReconnection = () => {
        ...
        console.log(`[SystemIntegration] Scheduling reconnection attempt ${reconnectAttempts + 1}/${maxReconnectAttempts} in ${delay}ms`);
