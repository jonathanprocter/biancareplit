class EnhancedFlashcardSystem {
    ...
    render() {
        ...
        container.innerHTML = '';
        if (this.flashcards.length === 0) {
            container.innerHTML = '<p>No flashcards available. Create some mathematical concepts or review practice problems to generate them automatically!</p>';
            return;
        }
            ...
            <div class="flashcard">
                ...
                <div class="flashcard-stats">
                    ...
                    <small class="text-muted">
                        ...
                        ${daysUntilReview > 0 ? 
                            `• Next review in ${daysUntilReview} day${daysUntilReview === 1 ? '' : 's'}` : 
                            '• Due for review'
                        }
                    </small>
                </div>
