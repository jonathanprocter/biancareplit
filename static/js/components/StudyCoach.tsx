...
const [messages, setMessages] = useState<ChatMessage[]>([]);
    ...
    useEffect(() => {
        ...
        setMessages([{
            role: 'assistant',
            content: 'Hello! I\'m your AI study coach. How can I help you prepare for the NCLEX exam today? I can generate practice questions, provide study tips, or help you focus on specific nursing topics.'
        }]);
    }, []);
