class AIStudyCoach {
    ...
    async askQuestion(question) {
        try {
            ...
            if (contentKeywords.includes('advanced') || contentKeywords.includes('complex') || 
                contentKeywords.includes('analyze') || contentKeywords.includes('evaluate')) {
                suggestedDifficulty = 'ADVANCED';
            } else if (contentKeywords.includes('basic') || contentKeywords.includes('identify') || 
                      contentKeywords.includes('list') || contentKeywords.includes('define')) {
